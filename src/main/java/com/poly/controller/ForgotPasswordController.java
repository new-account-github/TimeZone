...
public class ForgotPasswordController {
	...
	public String forgot(@RequestParam("username") String username, @RequestParam("email") String email, Model model, HttpSession session) {
...
//	    System.out.println(tokenveri);
	...
	public String confirmPass(Model model,@RequestParam("PassWord1") String PassWord1, @RequestParam("PassWord2") String PassWord2,HttpSession session) {
		String username = (String) session.getAttribute("username");
